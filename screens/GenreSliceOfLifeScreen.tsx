...
const sliceOfLifeBooks = [
  { id: '1', title: 'Himawari House', genre: 'Slice Of Life', viewers: '4.2M', image: require('../assets/himawari_house.png') },
];

export default function GenreSliceOfLifeScreen() {
  const navigation = useNavigation();

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        <Text style={styles.title}>Slice of Life Genre</Text>
        
        <FlatList
          data={sliceOfLifeBooks}
