...
const dramaBooks = [
  { id: '1', title: 'Kite Runner', genre: 'Drama', viewers: '8.2M', image: require('../assets/kite_runner.png') },
];

export default function GenreDramaScreen() {
  const navigation = useNavigation();

  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        <Text style={styles.title}>Drama Genre</Text>
